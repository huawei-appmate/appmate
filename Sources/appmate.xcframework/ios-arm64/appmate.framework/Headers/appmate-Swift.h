...
SWIFT_CLASS("_TtC7appmate9OfferWall")
...
/// Use this class to create events for various user activiy.
/// <ul>
///   <li>
///     Parameters:
///   </li>
///   <li>
///     productId: Pass the product id in case user view or purchase that product.
///   </li>
///   <li>
///     offeringId: Pass the offeringId in case the user views that offer. you can skip this value if the event is not from the offers page.
///   </li>
///   <li>
///     userEventType: the events that you can use in your app:
///     <ul>
///       <li>
///         AppLaunch:  send this on first app lunch if needed.
///       </li>
///       <li>
///         ViewProduct:  send this event when user view any of your product with productId.
///       </li>
///       <li>
///         PurchaseProduct: send this event when user purchases any of your products.
///       </li>
///     </ul>
///   </li>
/// </ul>
...
- (nonnull instancetype)initWithProductId:(NSString * _Nullable)productId offeringId:(NSString * _Nullable)offeringId userEventType:(enum UserEventType)userEventType OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
